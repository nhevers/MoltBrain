...
**Output:** `~/Scripts/claude-recall/actual_xml_only_with_timestamps.xml`
...
**Output:** `~/Scripts/claude-recall/all_xml_fragments_with_timestamps.xml`
...
Scripts read from: `~/.claude/projects/-Users-alexnewman-Scripts-claude-recall/*.jsonl`
