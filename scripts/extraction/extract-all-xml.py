...
transcript_dir = os.path.expanduser('~/.claude/projects/-Users-alexnewman-Scripts-claude-recall/')
...
output_file = os.path.expanduser('~/Scripts/claude-recall/all_xml_fragments_with_timestamps.xml')
