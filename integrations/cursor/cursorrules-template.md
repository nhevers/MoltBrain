# claude-recall Rules for Cursor
...
If you want to add custom instructions about claude-recall (beyond the auto-injected context), create a separate rules file:

### `.cursor/rules/claude-recall-instructions.mdc`

```markdown
---
alwaysApply: true
description: "Instructions for using claude-recall memory system"
---

# Memory System Usage

You have access to claude-recall, a persistent memory system. In addition to the auto-injected context above, you can search for more detailed information using MCP tools:
...
|------|---------|------------|
| `.cursor/rules/claude-recall-context.mdc` | Auto-injected context | Hook (automatic) |
| `.cursor/rules/claude-recall-instructions.mdc` | MCP tool instructions | You (optional) |
