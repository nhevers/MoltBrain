/**
 * Structured Logger for claude-recall Worker Service
...
// NOTE: This default must match DEFAULT_DATA_DIR in src/common/SettingsDefaultsManager.ts
// Inlined here to avoid circular dependency with SettingsDefaultsManager
const DEFAULT_DATA_DIR = join(homedir(), '.claude-recall');
