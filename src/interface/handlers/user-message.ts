...
import { ensureWorkerRunning, getWorkerPort } from '../../common/engine-utils.js';
import { HOOK_EXIT_CODES } from '../../common/hook-constants.js';
...
export const userMessageHandler: EventHandler = {
  async execute(input: NormalizedHookInput): Promise<HookResult> {
    ...
    console.error(
      "\n\n" + String.fromCodePoint(0x1F4DD) + " claude-recall Context Loaded\n" +
      "   " + String.fromCodePoint(0x2139, 0xFE0F) + "  Note: This appears as stderr but is informational only\n\n" +
      output +
      "\n\n" + String.fromCodePoint(0x1F4A1) + " Tip: Wrap any message with <private> ... </private> to prevent storing sensitive information.\n" +
